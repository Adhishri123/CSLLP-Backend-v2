...
public class PayrollServiceImpl implements PayrollService {
    ...
    public AnnualSalaryStructureDTO createAnnualSalaryStructure(Long employeeId, String authHeader) {
        try {
            ...
            String employeeName = (String) employeeData.getOrDefault("fullName", "Unknown");
    ...
    public PayslipDTO generatePayslip(Long employeeId, int month, int year, String authHeader) {
        ...
        try {
            ...
            System.out.println(" EMPLOYEE DETAILS RESPONSE: " + empDetails);
            System.out.println(" RESPONSE KEYS: " + (empDetails != null ? empDetails.keySet() : "null"));
            if (empDetails == null) {
                throw new PayrollException("Employee details not found for ID: " + employeeId);
            }

            // Map employee fields with null-safe defaults
            String employeeName = (String) empDetails.getOrDefault("fullName", "Unknown");
